...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Button for updating list of clients
        self.refresh_button = QAction('Обновить список', self)

        # Button for displaying message history
        ...
        # Last parameter for displaying window
        self.show()
